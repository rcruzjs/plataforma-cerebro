...
class ActionAgent:
    ...
    def execute_action(self, tool_name, arguments):
        ...
        if tool_name == "financial_mcp/process_payout":
            ...
            logger.info(f"[Action Agent] [MCP financial_mcp] Enviando solicitacao de transferencia no valor R$ {valor:.2f} para o banco do condominio {condo_id}")
